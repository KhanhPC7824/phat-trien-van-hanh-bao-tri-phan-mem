...
namespace ClothesWebNET.Areas.Admin.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "nameProduct,idProduct,sizeM,sizeL,sizeXL,price,description,idType")] Product product, HttpPostedFileBase img1, HttpPostedFileBase img2, bool? isFeatured)
        {
            if (Session["SESSION_GROUP_ADMIN"] != null)
            {
                // Handle Featured Tag
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "nameProduct,idProduct,sizeM,sizeL,sizeXL,price,description,idType")] Product product ,HttpPostedFileBase img1, HttpPostedFileBase img2, bool? isFeatured)
        {
            if (Session["SESSION_GROUP_ADMIN"] != null)
            {
                // Handle Featured Tag
                if (product.description == null) product.description = "";
                // Remove existing tag if any to avoid duplication or stale state, then re-add if checked
                product.description = product.description.Replace("<!--FEATURED-->", "");
